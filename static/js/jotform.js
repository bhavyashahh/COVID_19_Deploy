        ...
        var ready = function () {
            try {
                ...
                if ($$('.form-product-has-subproducts').length > 0) {
                    if (JotForm.newDefaultTheme || JotForm.isComparePaymentFormV1() || JotForm.newPaymentUIForNewCreatedForms === true) {
...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
    ...
    setFocusEvents: function () {
        ...
        if ((JotForm.newDefaultTheme || JotForm.isComparePaymentFormV1() || JotForm.newPaymentUIForNewCreatedForms === true) && (window.paymentType !== 'product' && window.paymentType !== 'subscription') && window.FORM_MODE !== 'cardform') {
        ...
        if ((JotForm.newDefaultTheme || JotForm.isComparePaymentFormV1() || JotForm.newPaymentUIForNewCreatedForms === true) && window.paymentType === 'product' && window.FORM_MODE !== 'cardform') {
        ...
        if ((JotForm.newDefaultTheme || JotForm.isComparePaymentFormV1() || JotForm.newPaymentUIForNewCreatedForms === true) && window.paymentType === 'subscription') {
        ...
        switch (resultFieldType) {
            ...
            case "html":
                try {
                    ...
                    if (spans.length == 0) {
                        var contents = calc.isLabel ? $('label_' + result).innerHTML : $((resultFieldType === 'inline' ? 'FITB_' : 'text_') + result).innerHTML;
                        if (calc.isLabel) {
                        ...
                        calc.isLabel ? $('label_' + result).update(contents) : $((resultFieldType === 'inline' ? 'FITB_' : 'text_') + result).update(contents);
                    } else {
